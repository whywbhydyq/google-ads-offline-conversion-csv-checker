...
export const metadata: Metadata = {
  title: "About the Local CSV Checker",
  description: "Learn what this browser-local Google Ads offline conversion CSV checker reviews, where its limits are, and how it protects row data.",
...
export default function AboutPage() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-12">
      ...
      <section className="mt-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <h2 className="text-2xl font-bold text-slate-950">How the checks are applied</h2>
        <p className="mt-3 leading-7 text-slate-700">
          The methodology page explains the local parsing pipeline, workflow-specific rule selection, severity levels, privacy boundary, and final Google Ads validation boundary.
        </p>
        <a href="/methodology" className="mt-4 inline-flex rounded-full bg-blue-700 px-5 py-3 text-sm font-semibold text-white hover:bg-blue-800">Read the methodology</a>
      </section>
      <section className="mt-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
