...
export const metadata: Metadata = {
  ...
  description: "Learn how to fix common Google Ads offline conversion CSV upload errors, including missing headers, invalid conversion time, old GCLIDs, un-hashed user data, and duplicates.",
};
