...
export const defaultDescription =
  "Check CSV-level Google Ads offline conversion upload risks locally before preview: headers, time formats, click IDs, consent fields, user-data risks, duplicates, value, and currency.";
