import { contentDateModified, contentLastUpdated } from "@/lib/site";

export const CONTENT_LAST_UPDATED = contentLastUpdated;
export const CONTENT_DATE_MODIFIED = contentDateModified;
...
export const officialSources = {
  ...
  googleAdsDataManager: {
    ...
    note: "Used for the enhanced conversions for leads and Data Manager boundary.",
  },
  googleAdsImportGuidelines: {
    title: "Google Ads Help: Guidelines for importing offline conversions",
    href: "https://support.google.com/google-ads/answer/15081888",
    note: "Used for upload timing windows, old conversion review signals, and final Google Ads validation boundaries.",
  },
  googleAdsBulkTemplates: {
    title: "Google Ads Help: Download templates for conversion bulk uploads",
    href: "https://support.google.com/google-ads/answer/15202086",
    note: "Used for the template and file-format boundary. This checker focuses on CSV preflight and does not support every Google Ads template format.",
  },
  googleAdsApiOffline: {
  ...
  googleAdsApiTroubleshooting: {
    title: "Google Ads API: Offline conversion troubleshooting",
    href: "https://developers.google.com/google-ads/api/docs/conversions/troubleshooting",
    note: "Used for click-conversion troubleshooting boundaries, including rows that combine multiple click IDs.",
  },
  googleAdsEclDiagnostics: {
    title: "Google Ads Help: Enhanced conversions for leads diagnostics report",
    href: "https://support.google.com/google-ads/answer/15249267",
    note: "Used for user-provided data hashing, normalization, and match-quality diagnostics context.",
  },
