...
const startHere = [
  ...
  },
  {
    ...
    href: "/methodology",
    body: "Use this when you need to explain how severity, workflow selection, and privacy boundaries are applied.",
    audience: "Agencies, PPC leads, and data owners documenting review steps",
  },
];
