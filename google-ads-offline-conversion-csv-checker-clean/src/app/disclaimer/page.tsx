...
export const metadata: Metadata = {
  title: "CSV Checker Disclaimer",
  description: "Review the limits of this browser-local Google Ads offline conversion CSV checker before using its report for upload decisions.",
